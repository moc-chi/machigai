...
export const SettingsUpdateSchema = z.object({
  ...
  sourceType: z.enum(["standard", "original"]).optional(),
...
export type GameSettings = {
  ...
  countdownSeconds: number; zoomMin: number; zoomMax: number; imageIds: ImageSelection; sourceType: "standard" | "original";
};
