...
function ExportBoard({imageUrl,imageSize,differences,view,onView,label,filename,marks=false}:{imageUrl:string;imageSize?:{width:number;height:number};differences:Difference[];view:View;onView:(view:View)=>void;label:string;filename:string;marks?:boolean}){
